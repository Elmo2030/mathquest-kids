 ...
 *         large "Play" CTA, and "Parents Dashboard" button guarded by MathGate.
 */
  ...
  return (
    <>
      ...
      >
        ...
        {/* Top bar: Logo + Settings shortcut */}
        <motion.header
        ...
        >
          ...
          {/* Settings shortcut — also goes through gate */}
          <button
        ...
        <main className="relative z-10 flex flex-1 flex-col items-center justify-center px-6 py-8 gap-6 md:gap-8">
          ...
          >
            ...
            >
              ...
              {/* Secondary: Parents Dashboard (gated) */}
              <motion.button
